...
import { addToAppointment } from '../slices/appointmentSlice';
  ...
  if (!service) {
    return (
      <>
        ...
        <Message variant="danger">Usluga nije pronađena</Message>
      </>
    );
  }
        ...
        <Row className="align-items-center">
          <Col md={8}>
            ...
            <Rating
              ...
              text={`${service.numReviews} utisaka`}
            />
          </Col>
      ...
      <Row className="gy-4">
        ...
        <Col lg={4}>
          <Card className="border-0 shadow-sm">
            <Card.Body>
              <h4 className="mb-4">Informacije o usluzi</h4>
              ...
              <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                {service.countInStock > 0 ? (
                  <Badge bg="success">Slobodan termin</Badge>
                ) : (
